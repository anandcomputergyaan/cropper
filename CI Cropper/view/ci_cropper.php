  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      ...
      <div  class="row" >
        ...
        <div class="col-md-8">
          <br>
          <form action="Home/crop_img" method="post"  id="form_id" enctype="multipart/form-data" >
            <table class="table responsive form-group">
              ...
              <tr> <td><b> Image: </b></td>
              <td>
                <img id="preview_baner_img2" src="" class="img-responsive" style="width:120px;" >
                <input type="hidden" value="" name="image" id="banner_img2"><!-- id image set with Number  -->

                <div class="docs-toggles">
                  <div class="btn-group d-flex flex-nowrap" data-toggle="buttons">
                    <label class="btn  btn-info">
                      
                      <input type="radio" class="sr-only" id="aspectRatio0" name="aspectRatio" value="1"> <!-- set value=height/width  -->
                      
                      <span  onclick="fun_set_id(2)" data-toggle="modal" data-target="#banner_img1_modal" class="docs-tooltip"  data-animation="false" title="" data-original-title="aspectRatio: 1/1"><!-- set ratio  -->
                        Upload Image
                      </span>
